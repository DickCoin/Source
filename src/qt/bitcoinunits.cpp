...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DICK");
    case mBTC: return QString("mDICK");
    case uBTC: return QString::fromUtf8("μDICK");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Dickcoins"));
    case mBTC: return QString(QObject::tr("Milli-Dickcoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Dickcoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
