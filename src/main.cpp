...
const string strMessageMagic = "Dickcoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("Dickcoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Dickcoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // Dickcoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Dickcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "DICK";
        CTransaction txNew;
        txNew.nTime = 1465345401;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1465345501;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1002573; // !fTestNet ? 1575379 : 46534;
	
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3cee630b6e44d19d9d5d4df78cf5de5a771e240a47d057b3b724fb2884f4683c"));
...
unsigned char pchMessageStart[4] = { 0xc4, 0xf8, 0xe7, 0xe8 };
